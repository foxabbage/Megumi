...
这是一个个人写的小项目，想法是做一个像Neuro那样的AI Vtuber，不过成熟程度远不及她。</br>
...
3. 现在AI的gui操作只能点击一些体积极大的选项(ViT的gui操作就好比让大模型数清楚一个strawberry里有几个r)。如何改进？我能想到的一个方法是使用传统CNN预分割，像浏览器的gui处理那样。
